...
function init(that, barHeight, keys, isShowKey, isShowHis, callBack, top, modelType) {
  var temData = {};
  var view = {
    barHeight: barHeight,
    isShow: false
  ...
  wx.getSystemInfo({
    success: function(res) {
      ...
      temData.view = view;
      temData.top = top;
      if (modelType == 1) {//详情页搜索
        temData.modelTop = 140;
        temData.modelHeight = view.windowHeight -140;
      }
      that.setData({
