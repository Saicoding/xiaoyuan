...
Page({
  ...
  onShow: function () {
    ...
    app.post(API_URL, "action=getXueshiRecords&loginrandom=" + loginrandom + "&zcode=" + zcode + "&page=1", false, false, "", "", "", self).then(res => {
  ...
  onReachBottom: function () {
    ...
    app.post(API_URL, "action=getXueshiRecords&loginrandom=" + loginrandom + "&zcode=" + zcode + "&page=" + page, false, false, "", "", "", self).then(res => {
